...
* [GitHub](https://github.com/) -  For version control and commiting to GitHub.
...
### User story testing
 ...
 1. As a user, I want to be able to see fixtures dates and kick off times
    ...
    Users are presented with a clear layout of teams with a button which they can click on to reveal fixture infomation.
 ...
 2. As a user, i want to see details of the stadiums that I am going to and details about the other teams in my league.
    ...
    They are prompted to click on markers to reveal further infomation via an info window. All functions in this section
...
Bootstrap 4 was used to assist with site responsiness and layout
